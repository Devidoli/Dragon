...
import { LIQUOR_VOLUMES, CATEGORIES, ADMIN_EMAILS } from '../constants';
import { Users, Package, TrendingUp, Plus, ArrowUpRight, Flame, Trash2, ShoppingCart, Upload, ShieldCheck, Clock, CheckCircle, RefreshCcw, Database, Loader2, Check } from 'lucide-react';
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ users, products, orders, counterSales, approveUser, addProduct, deleteProduct, updateStock, addCounterSale, onRefresh }) => {
  ...
  const handleApprove = async (id: string) => {
    ...
    if (success) {
      ...
      alert("APPROVAL FAILED: Database rejected the update. Please ensure your Supabase RLS policies allow 'UPDATE' on the 'users' table.");
    }
  };
